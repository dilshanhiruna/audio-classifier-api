...
async def convert_yt_to_audio(url: str):
    ...
    try:
        ...
        for filename in os.listdir("./ytconverts"):
            os.remove("./ytconverts/{}".format(filename))
        ...
        # convert mp3 to wav
        data, samplerate = sf.read("./ytconverts/{}.wav".format(video_id))
        sf.write("./ytconverts/{}.mp3".format(video_id), data, samplerate)

        # delete the wav file
        os.remove("./ytconverts/{}.wav".format(video_id))

        file_path = "./ytconverts/{}.mp3".format(video_id)
